		...
		<div id="body-area">
			<div class="request-password-reset">
				...
				<form id="login">
					...
					<p><label for="email-requestPasswordReset"> We'll send instructions to the email below. </label></p>
					<div class="fieldgroup">
						<p>
							<span id="email-requestPasswordReset-error" class="error">Please enter a valid email address.</span><br /><br />
							<input id="email-requestPasswordReset" type="email" data-ime-mode-disabled="" autocapitalization="off" autocorrect="off" value="" name="email" />
						</p>
					</div>
