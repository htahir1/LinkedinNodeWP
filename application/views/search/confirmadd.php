					...
					<div class="iwrite">
						<div class="iwrite-in">
							...
							<div class="ipaper">
								<div class="ipaper-in">
									<div class="wrap">
										<h1><?php echo $friendid ?></h1>
										<input type="hidden" name="userid" id="userid" value=<?php echo $friendid ?> />
										<span id="reason-iweReconnect-error" class="error"></span>
										<strong class="dark">How do you know <?php echo $connection_data->fname ?>?</strong>
										<ul id="main-options">
											<li>
											...
											<li>
												...
												<label for="selector-IC-reason-6">I dont know <?php echo $connection_data->fname ?></label>
											</li>
										</ul>
										<strong class="dark">
