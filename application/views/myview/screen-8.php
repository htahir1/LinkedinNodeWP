		...
		<div id="body-area" class="lessmargin">
			<div class="main-body-white">
				<div class="alert error" role="alert">
					<p><strong>There were one or more errors in your submission. Please correct the marked fields below.</strong></p>
				</div>
						...
						<form id="yui-gen2" class="standard-form sided">
							<ul>
								...
								<li>
									...
									<div class="fieldgroup">
										<span id="email-coldRegistrationForm-error" class="error">The text you provided is too short (the minimum length is 3 characters, your text contains 2 characters).</span>
								...
								<li class="password-field">
									...
									<div class="fieldgroup">
										<span id="password-coldRegistrationForm-error" class="error">The password you provided must have at least 6 characters.</span>
